                ...
                <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                    ...
                    <div className="input-button">
                        <button type='button' className={styles.button_custom} onClick={handleGoogleSignin}>
                            Sign In with Google <Image src={'/assets/google.svg'} width="20" height={20} alt="SignIn with Google"></Image>
                        </button>
                    </div>
                    <div className="input-button">
                        <button type='button' className={styles.button_custom} onClick={handleGithubSignin}>
                            Sign In with Github <Image src={'/assets/github.svg'} width={25} height={25} alt="SignIn with Github"></Image>
                        </button>
                    </div>
                </form>
